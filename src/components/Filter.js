...
export default function Filter() {
    ...
    return (
        <div className="relative z-30">
            ...
            {open &&
                <div className="absolute top-12 left-0 w-full p-3 pb-7 bg-gray-400">
                    <div className='w-full flex justify-between items-center pb-3 border-b border-b-gray-300'>
                        ...
                        >Reset</button>
                        <button 
                            className="w-5 h-5 rounded-sm flex justify-center items-center hover:bg-gray-500 hover:text-gray-100 transition"
                            onClick={closeFilter}
                        >&times;</button>
                    </div>
                    ...
                    <div className="mt-3 w-full">
                        ...
                        <div className="grid grid-cols-3 justify-between items-center gap-2 mt-3 w-full">
                            {state.searchedTypes.map(type => (
                                <div key={type.name} className="grid grid-cols-2 gap-5 justify-between items-center">
