...
export default function About({ weight, height, active }) {
    return (
        <>
            <div className={`${active === 'about' ? 'animate-flyIn': 'hidden' } w-80 p-3 text-center bg-gray-900 mt-7 mx-auto rounded-xl flex flex-row text-gray-100 translate-y-12 opacity-0 lg:w-4/5`}>
            <div className="grow">
